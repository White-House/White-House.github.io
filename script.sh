...
sed -i '' -e 's/<i class="fas fa-moon"><\/i><\/label>/<i class="fas fa-moon"><\/i><\/label><\/div><div class="navbar-logo logo-center"><a href="#top"><img src=".\/assets\/images\/benoit-maison-blanche_white.png" id="logo" alt="Benoit Maison-Blanche" title="Benoit Maison-Blanche" style="height: 3.8rem;"><\/a>/g' ./index.html
