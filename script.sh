...
sed -i '' -e 's/<i class="fas fa-moon"><\/i><\/label>/<i class="fas fa-moon"><\/i><\/label><\/div><div class="navbar-logo" style="logo-center"><span class=""><a href=".\/index.html"><img src=".\/assets\/images\/Benoit-Maison-Blanche_White.png" alt="Benoit Maison-Blanche" title="Benoit Maison-Blanche" style="height: 3.8rem;"><\/a><\/span>/g' ./index.html
